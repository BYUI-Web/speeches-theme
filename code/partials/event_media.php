...
if ($post_status == "past") {
    ...
    if ($video_status == "yes") {
        ...
        $video_player = "<img src='".get_template_directory_uri()."/assets/images/devo.png'/>";
    ...
    <div class="additional-featured group">
        <div class="custom-box <?php echo ($video_status != "yes") ? 'disabled' : ''; ?>">
            <a href="javascript:void(0)" onclick="dispVideo(this)">
                <img class="feat_icon" src="<?php bloginfo('template_url'); ?>/assets/images/<?php echo ($video_status == "yes") ? 'tv' : 'tv-inactive'; ?>.png" >
                <div class="right">
                    <h3>Watch</h3>
                </div>
            </a>
        ...
        <div class="custom-box <?php echo ($audio_status != "yes") ? 'disabled' : ''; ?>">
            <a href="javascript:void(0)" onclick="dispListen(this)">
                <img class="feat_icon" src="<?php bloginfo('template_url'); ?>/assets/images/<?php echo ($audio_status == "yes") ? 'headphones' : 'listen-inactive'; ?>.png" >
                <div class="right">
                    <h3>Listen</h3>
                </div>
            </a>
        ...
        <div class="custom-box <?php echo ($transcript_status != "yes") ? 'disabled' : ''; ?>">
            <a href="javascript:void(0)" onclick="dispRead(this)">
                <img class="feat_icon" src="<?php bloginfo('template_url'); ?>/assets/images/<?php echo ($transcript_status == "yes") ? 'read' : 'read-inactive'; ?>.png" >
                <div class="right">
                    <h3>Read</h3>
                </div>
            </a>
        ...
        <div class="custom-box last">
            <a href="javascript:void(0)" onclick="dispDiscuss()">
                <img class="feat_icon" src="<?php bloginfo('template_url'); ?>/assets/images/chatbubble.png" >
                <div class="right">
                    <h3>Discuss</h3>
                </div>
            </a>
