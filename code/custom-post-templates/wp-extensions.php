...
function admin_dependencies() {
    echo '<link rel="stylesheet" href="' . get_bloginfo('template_url') . '/assets/css/admin/token-input.css">';
}

add_action('admin_head', 'admin_dependencies');

function my_admin_footer_function() {
    echo '<script src="' . get_bloginfo('template_url') . '/assets/js/speechesjs.min.js"></script>';
}

add_action('admin_footer', 'my_admin_footer_function');

function my_head_function() {
    // echo '<script src="' . get_bloginfo('template_url') . '/custom-posts/js/mediaDisplay.js"></script>';
}
...
function indv_pages($template) {
   ...
   //A Simple Page
    ...
    if ($page == '/raw-search') {
        $templatefilename = 'the_search.php';
...
add_action("template_include", 'indv_pages');
