        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img class="carousel-image" src="<?php bloginfo('template_url'); ?>/assets/images/home/homepage-1.jpg" />
                    <div class="carousel-caption pull-left">
                        <h2>Come to devotional prepared to learn, Tuesdays at 2:10 p.m. in the I-Center.</h2>
                    </div>
                </div>
                <div class="item">
                    <img class="carousel-image" src="<?php bloginfo('template_url'); ?>/assets/images/home/homepage-2.jpg" />
                    <div class="carousel-caption pull-left">
                        <h2>Volunteer to be a Devotional usher. Click here to learn more.</h2>
                    </div>
                </div>
                <div class="item">
                    <img class="carousel-image" src="<?php bloginfo('template_url'); ?>/assets/images/home/homepage-3.jpg" />
                    <div class="carousel-caption pull-left">
                        <h2>Attend University Forums to learn more about special topics.</h2>
                    </div>
                </div>
                <div class="item">
                    <img class="carousel-image" src="<?php bloginfo('template_url'); ?>/assets/images/home/homepage-4.jpg" />
                    <div class="carousel-caption pull-left">
