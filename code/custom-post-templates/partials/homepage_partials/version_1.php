...
<div class="hero-feature">
	<div class="container">
		<img class="feature-image col-xs-12 col-sm-7" src="<?php bloginfo('template_url'); ?>/assets/images/hero_placeholder.jpg">
...
<div class="featured-speeches">
	...
	<div class="col-xs-12 col-sm-4">
		<div class="featured-item">
			...
			<div class="feature-image"> <?php if ( has_post_thumbnail() ) { the_post_thumbnail(); } else {  ?> <img src="<?php bloginfo('template_url'); ?>/assets/images/devo.png"> <?php } ?></div>
		</div>
	</div>
<?php }} else { ?>
<div class="col-xs-12 col-sm-4">
	<div class="featured-item">
		...
		<div class="feature-image"><img src="<?php bloginfo('template_url'); ?>/assets/images/devo.png"></div>
	</div>
</div>
<?php } ?>
</div>
